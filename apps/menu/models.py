...
class MenuItem(models.Model):
    ...
    def get_type_translated(self, lang="ru"):
        ...
        # Professional English translations for MenuItem
        ...
        mapping = {
            c[0]: {
                "ru": c[1], 
                "uz": c[2], 
                "en": english_translations.get(c[0], c[1])
    ...
    def get_type_choices_translated(cls, lang="ru"):
        ...
        if lang == "uz":
            ...
            return [(c[0], english_translations.get(c[0], c[1])) for c in cls.TYPE_CHOICES]
...
class Beverage(models.Model):
    ...
    def get_type_translated(self, lang="ru"):
        """Get translated type name based on language"""
        # Professional English translations for Beverage
        english_translations = {
            "coffee": "Coffee",
            "new_drinks": "New Beverages",
            "iced_coffee": "Iced Coffee",
            "cold_drinks": "Cold Beverages",
            "decaf": "Decaffeinated",
            "fresh_juices": "Fresh Juices",
            "tea": "Tea",
            "not_coffee": "Non-Coffee Drinks"
        }
